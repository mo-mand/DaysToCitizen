const help = {
  ...
  faq: {
    ...
    a2: 'Time spent in Canada before your PR date can count at a 2-for-1 rate (maximum 365 credited days). Select "Other status" when logging those stays and DaysToCitizen will apply the correct rate.',
